...
export const metadata: Metadata = {
  title: "Cadastro | Beleza & Bem-Estar",
  description: "Crie sua conta para agendar servicos.",
};

/**
 * Pagina de Cadastro.
 * Formulario completo para novo cliente.
 */
        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-xl bg-white p-8 shadow-md">
            ...
            <p className="mt-2 text-sm text-marrom/60">
              Cadastre-se para agendar seus servicos
            </p>
