  ...
  if (!resetToken) {
    return (
      <AuthLayout
        icon={AlertTriangle}
        title="Link invalido"
        subtitle="Este link de redefinicao de senha esta incompleto ou invalido"
        footer={
      ...
      >
        <p className="text-sm text-foreground text-center">
          O link que voce usou parece estar incompleto. Por favor, solicite um novo email de redefinicao de senha.
        </p>
      </AuthLayout>
    );
  }
